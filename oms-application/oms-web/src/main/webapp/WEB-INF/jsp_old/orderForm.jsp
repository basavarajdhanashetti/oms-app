		...
		<div class="sidebar" data-color="purple"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="active"><a href="/process/orders"> <i
							class="pe-7s-file"></i>
							<p>Place New Order</p>
					</a></li>
					<li><a href="/process/tasks"> <i class="pe-7s-file"></i>
							<p>My Tasks</p>
					</a></li>
					<li><a href="/uploadExcel"> <i class="pe-7s-user"></i>
							<p>Upload File</p>
					</a></li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="content">
									<form:form commandName="orderDetails">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<form:input path="deliveryAddressId" class="form-control" />
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>Payment Received</label>
												<form:select path="isPaymentReceived" class="form-control">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<c:choose>
													<c:when test="${orderDetails.taskId gt 0 }">
															<button type="submit" formaction="${pageContext.request.contextPath}/process/orders/complete"
													class="btn btn-info btn-fill pull-right" >Re-Submit</button>
													</c:when>
													<c:otherwise>
														<button type="submit" formaction="${pageContext.request.contextPath}/process/orders"
